...
// string at their boundary and stay fine; the bigger beneficiary, numeric seeding sorting, still
...
// Challenger is protected at the top: only LK >= 20 (weaker players).
// A stronger LK is too strong → hint toward the championship field.
