...
// exactly a digit wide in the tabular figures all three surfaces set, and nothing is joined between them —
// that one pad is the whole gap, which is as tight as the column can be drawn. This is the one file that spells that
